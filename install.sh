...
yaourt -S system-san-francisco-font-git ttf-ms-fonts ttf-font-awesome paper-gtk-theme-git paper-icon-theme-git imagemagick xss-lock-git visual-studio-code spotify
